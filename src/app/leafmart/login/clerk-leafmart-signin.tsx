...
// Client-only Leafmart-themed Clerk SignIn widget. Isolated so
// @clerk/nextjs only loads when AUTH_PROVIDER=clerk AND a user actually
// hits this page — avoiding the boot-time crash that prompted EMR-205.

import { SignIn } from "@clerk/nextjs";

export default function ClerkLeafmartSignIn() {
  return (
    <SignIn
      signUpUrl="/leafmart/signup"
