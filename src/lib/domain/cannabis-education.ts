...
export const CANNABINOIDS: Cannabinoid[] = [
  ...
  // EMR-354: individual cannabinoids that Dr. Patel wants represented in
  // patient education even when the evidence base is still emerging.
  { name: "CBDA", abbreviation: "CBDA", emoji: "\uD83C\uDF31", psychoactive: false, simpleDescription: "The acidic precursor to CBD. Found in raw, unheated cannabis. Some research suggests anti-nausea effects at lower doses than CBD.", benefits: ["Nausea reduction", "Anti-inflammatory", "Anti-anxiety (animal models)"], conditions: ["nausea", "inflammation", "anxiety"], typicalDoseRange: "10-50 mg/day", evidence: "emerging" },
  { name: "CBDV", abbreviation: "CBDV", emoji: "\uD83C\uDF3F", psychoactive: false, simpleDescription: "Structurally similar to CBD. Promising for seizures, autism-spectrum behaviors, and gut inflammation.", benefits: ["Anti-seizure", "Neuroprotective", "Anti-nausea"], conditions: ["epilepsy", "autism", "GI inflammation"], typicalDoseRange: "5-50 mg/day", evidence: "emerging" },
  { name: "CBGA", abbreviation: "CBGA", emoji: "\uD83C\uDF3F", psychoactive: false, simpleDescription: "The acidic 'mother' cannabinoid \u2014 every other cannabinoid is biosynthesized from CBGA. Early research signals for metabolic and antiviral activity.", benefits: ["Metabolic regulation", "Antiviral (early)", "Anti-inflammatory"], conditions: ["metabolic syndrome", "inflammation"], typicalDoseRange: "5-20 mg/day", evidence: "emerging" },
  { name: "THCA", abbreviation: "THCA", emoji: "\uD83C\uDF3F", psychoactive: false, simpleDescription: "The acidic precursor to THC. Non-intoxicating in raw form. Anti-inflammatory and neuroprotective signals; converts to THC when heated.", benefits: ["Anti-inflammatory", "Neuroprotective", "Anti-nausea"], conditions: ["inflammation", "neurodegeneration"], typicalDoseRange: "5-20 mg/day", evidence: "emerging" },
  { name: "Full Extract", abbreviation: "FECO", emoji: "\u2728", psychoactive: true, simpleDescription: "Full-extract cannabis oil \u2014 a whole-plant extract containing the complete cannabinoid + terpene profile (vs. an isolate of a single cannabinoid). Often used at higher doses for severe conditions; the 'entourage effect' is the leading hypothesis.", benefits: ["Whole-plant entourage effect", "Synergistic relief", "Often more potent than isolates"], conditions: ["cancer", "severe pain", "treatment-resistant epilepsy", "palliative care"], typicalDoseRange: "Varies \u2014 physician-supervised titration recommended", evidence: "emerging" },
];
