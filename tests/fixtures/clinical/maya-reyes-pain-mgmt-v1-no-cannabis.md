# Maya Reyes — SOAP Exemplar (Pain Management, v1, no cannabis)

> Pain-Management-non-cannabis-only variant of `maya-reyes-pain-mgmt-v1.md`.
> Cannabis medications (#8 Camino edibles, #9 PhytoRx tincture) are removed;
> everything else is byte-identical with its parent fixture. Use this as the
> acceptance fixture for the Pain-Management v1 gate.
...
## Medications (with category bubbles, cannabis removed)
