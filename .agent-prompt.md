...
**Your Task:**
Build a Patient Lab/Document Email & Print action menu (EMR-032) in src/components/patient/document-actions.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-05-print`
