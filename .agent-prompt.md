...
**Your Task:**
Build a Visual Health Roadmap component (EMR-010) in src/components/patient/health-roadmap.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-08-roadmap`
