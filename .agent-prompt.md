...
**Your Task:**
Build a DICOM Viewer scaffold component (EMR-014) in src/components/dicom/dicom-viewer.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-10-dicom`
