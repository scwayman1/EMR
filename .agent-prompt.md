...
**Your Task:**
Build the Pricing & Subscription Tiers marketing component (EMR-049) in src/components/marketing/pricing-table.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-30-pricing`
