...
**Your Task:**
Create the Dosing Recommendation Engine agent stub (EMR-004) in src/lib/agents/dose-recommender.ts.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-26-dose-rec`
