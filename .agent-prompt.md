...
**Your Task:**
Build the PTSD Screener (PCL-5) form (EMR-066) in src/components/intake/pcl5-screener.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-47-pcl5`
