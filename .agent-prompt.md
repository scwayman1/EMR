...
**Your Task:**
Build Apple-style Health Rings for Gamify Health (EMR-023) in src/components/gamification/health-rings.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-12-rings`
