...
**Your Task:**
Build the Cannabis Combo Wheel shell component (EMR-001) in src/components/education/combo-wheel-shell.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-14-wheel`
