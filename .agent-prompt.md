...
**Your Task:**
Build the Depression Screener (PHQ-9) form (EMR-065) in src/components/intake/phq9-screener.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-46-phq9`
