...
**Your Task:**
Refactor the patient vitals card to use warmer, human-centric wording (EMR-011) in src/components/patient/vitals-card.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-04-vitals`
