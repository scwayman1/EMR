...
**Your Task:**
Build the Cannabis Plant 101 front page marketing component (EMR-040) in src/components/marketing/plant-101.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-28-plant101`
