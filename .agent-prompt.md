...
**Your Task:**
Build the About Page - Founders & Mission component (EMR-048) in src/components/marketing/founders-story.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-29-founders`
