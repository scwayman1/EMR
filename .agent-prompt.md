...
**Your Task:**
Build a Dispensary Locator Map placeholder component (EMR-017) in src/components/dispensary/locator-map.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-09-locator`
