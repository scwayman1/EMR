...
**Your Task:**
Build a Product Store Affiliate Link Card component (EMR-039) in src/components/store/affiliate-product-card.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-06-affiliate`
