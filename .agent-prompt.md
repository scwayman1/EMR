...
**Your Task:**
Build the Milligram-Based Dosing Display component (EMR-003) in src/components/prescription/dosing-display.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-15-dosing`
