...
**Your Task:**
Build the Justin Kander's Book & Resources education component (EMR-036) in src/components/education/kander-resources.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-07-kander`
