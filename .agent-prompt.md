...
**Your Task:**
Build a Positive Input Requirement prompt component (EMR-024) in src/components/patient/positive-input-prompt.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-13-positive`
