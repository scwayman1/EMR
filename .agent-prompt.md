...
**Your Task:**
Create the Insurance Eligibility Checker API client scaffold (EMR-046) in src/lib/billing/eligibility-client.ts.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-24-eligibility`
