# Mallik decomposition — patel-001-billing-insurance

> Generated by `agent:mallik@1.0.0` from `patel-001-billing-insurance.md`.
...
- The prompt appears truncated ("…it integrated into i"). Could you complete the final sentence? Mallik needs to know the intended integration target.
